...
local debugMessagesLocales = {
    ...
    ["The '%s' world event starts in about %d hours."] = {
        ...
        ["frFR"] = "L'évènement mondial '%s' commence dans environ %d heures.",
        ["zhCN"] = "世界事件 '%s' 将在约 %d 小时后开始。",
        ["enUS"] = true,
        ["zhTW"] = "世界事件 '%s' 將在約 %d 小時後開始。",
        ["deDE"] = "Das '%s' Feiertag-Event beginnt in ungefähr %d Stunden.",
    ...
    ["The '%s' world event starts in less than an hour."] = {
        ...
        ["frFR"] = "L'évènement mondial '%s' commence dans moins d'une heure.",
        ["zhCN"] = "世界事件 '%s' 将在不到一小时后开始。",
        ["enUS"] = true,
        ["zhTW"] = "世界事件 '%s' 將在不到一小時後開始。",
        ["deDE"] = "Das '%s' Feiertag-Event beginnt in weniger als einer Stunde.",
        ["esES"] = "¡El evento mundial '%s' empieza en menos de una hora!",
        ["esMX"] = "¡El evento mundial '%s' empieza en menos de una hora!",
    },
