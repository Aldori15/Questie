...
local trackerOptionsLocales = {
    ...
    ["Minimize In Instances"] = {
        ...
        ["ruRU"] = "Свернуть в подземельях, рейдах и на полях боя",
        ["deDE"] = "In Instanzen minimieren",
        ["koKR"] = "인스턴스에서 최소화",
        ["esMX"] = "Minimizar en instancias",
        ["enUS"] = true,
        ["zhCN"] = "在副本中最小化",
        ["zhTW"] = "在副本中最小化",
        ["esES"] = "Minimizar en instancias",
    ...
    ["If checked, the Questie Tracker will automatically be minimized when entering a dungeon, raid, or battleground."] = {
        ["ptBR"] = "Se marcado, o Rastreador será automaticamente minimizado ao entrar em uma masmorra, raide ou campo de batalha.",
        ["ruRU"] = "Когда включено, при входе в подземелье, рейд или на поле боя трекер будет автоматически свернут.",
        ...
        ["koKR"] = "이 옵션을 선택하면 던전, 공격대 또는 전장에 입장할 때 Questie 추적기가 자동으로 최소화됩니다.",
        ["esMX"] = "Si está seleccionado, el rastreador se minimizará automáticamente al entrar en un calabozo, banda o campo de batalla.",
        ["enUS"] = true,
        ["zhCN"] = "启用时，进入地下城、团队副本或战场时追踪器将自动最小化。",
        ["zhTW"] = "啟用時，進入地城、團隊副本或戰場時，任務清單會自動最小化。",
    ...
    ["Hide In Instances"] = {
        ...
        ["esES"] = "Ocultar en instancias",
        ["esMX"] = "Ocultar en instancias",
        ["frFR"] = "Cacher dans les instances",
        ["koKR"] = "인스턴스에서 숨기기",
        ["ptBR"] = "Ocultar em instâncias",
        ["ruRU"] = "Скрывать в подземельях, рейдах и на полях боя",
        ["zhCN"] = "在副本中隐藏",
        ["zhTW"] = "在副本中隱藏",
    },
    ["If checked, the Questie Tracker will automatically be hidden when entering a dungeon, raid, or battleground."] = {
        ...
        ["koKR"] = "이 옵션을 선택하면 던전, 공격대 또는 전장에 입장할 때 Questie 추적기가 자동으로 숨겨집니다.",
        ...
        ["zhCN"] = "启用时，进入地下城、团队副本或战场时追踪器将自动隐藏。",
        ["zhTW"] = "啟用時，進入地城、團隊副本或戰場時，任務清單會自動隱藏。",
    },
    ---------------------------------------------------------
