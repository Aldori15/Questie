...
local generalOptionsLocales = {
    ...
    ["Detach Minimap Button"] = {
        ["enUS"] = true,
        ["deDE"] = "Minikarten-Schaltfläche lösen",
        ["esES"] = "Desacoplar botón del minimapa",
        ["esMX"] = "Desacoplar botón del minimapa",
        ["frFR"] = "Détacher le bouton de la minicarte",
        ["koKR"] = "미니맵 버튼 분리",
        ["ptBR"] = "Desanexar botão do minimapa",
        ["ruRU"] = "Отвязать кнопку от миникарты",
        ["zhCN"] = "分离小地图按钮",
        ["zhTW"] = "分離小地圖按鈕",
    },
    ["Detach the Questie minimap button from the minimap and allow it to be moved anywhere on the screen."] = {
        ["enUS"] = true,
        ["deDE"] = "Löst die Questie-Schaltfläche von der Minikarte und ermöglicht es, sie frei auf dem Bildschirm zu verschieben.",
        ["esES"] = "Desacopla el botón de Questie del minimapa y permite moverlo libremente por la pantalla.",
        ["esMX"] = "Desacopla el botón de Questie del minimapa y permite moverlo libremente por la pantalla.",
        ["frFR"] = "Détache le bouton Questie de la minicarte et permet de le déplacer librement n'importe où sur l'écran.",
        ["koKR"] = "Questie 미니맵 버튼을 미니맵에서 분리하여 화면 어디든 자유롭게 이동할 수 있게 합니다.",
        ["ptBR"] = "Desanexa o botão do Questie do minimapa e permite movê-lo livremente para qualquer lugar da tela.",
        ["ruRU"] = "Отвязывает кнопку Questie от миникарты и позволяет свободно перемещать её в любое место на экране.",
        ["zhCN"] = "将 Questie 小地图按钮与小地图分离，并允许将其自由移动到屏幕上的任意位置。",
        ["zhTW"] = "將 Questie 小地圖按鈕與小地圖分離，並允許將其自由移動到畫面上的任意位置。",
    },
    ...
    ["Show active world event notifications"] = {
        ["enUS"] = true,
        ["deDE"] = "Benachrichtigungen zu aktiven Weltereignissen anzeigen",
        ["esES"] = "Mostrar notificaciones de eventos del mundo activos",
        ["esMX"] = "Mostrar notificaciones de eventos del mundo activos",
        ["frFR"] = "Afficher les notifications d'événements mondiaux actifs",
        ["koKR"] = "활성화된 월드 이벤트 알림 표시",
        ["ptBR"] = "Mostrar notificações de eventos mundiais ativos",
        ["ruRU"] = "Уведомления об активных мировых событиях",
        ["zhCN"] = "显示已激活的世界事件通知",
        ["zhTW"] = "顯示已啟動的世界事件通知",
    },
    ["Print a chat message when a world event is active or about to start."] = {
        ["enUS"] = true,
        ["deDE"] = "Gibt eine Chatnachricht aus, wenn ein Weltereignis aktiv ist oder bald beginnt.",
        ["esES"] = "Muestra un mensaje de chat cuando un evento del mundo está activo o está a punto de empezar.",
        ["esMX"] = "Muestra un mensaje de chat cuando un evento del mundo está activo o está a punto de empezar.",
        ["frFR"] = "Affiche un message dans la discussion lorsqu'un événement mondial est actif ou sur le point de commencer.",
        ["koKR"] = "월드 이벤트가 활성화되었거나 곧 시작될 때 대화창에 메시지를 표시합니다.",
        ["ptBR"] = "Mostra uma mensagem no bate-papo quando um evento mundial está ativo ou prestes a começar.",
        ["ruRU"] = "Выводит сообщение в чат, когда мировое событие активно или скоро начнется.",
        ["zhCN"] = "当世界事件已激活或即将开始时，在聊天中显示消息。",
        ["zhTW"] = "當世界事件已啟動或即將開始時，在聊天視窗顯示訊息。",
    },
    ["Sound Options"] = {
        ["enUS"] = true,
    ...
    ["Simplify quest objective text by removing \"slain\" from it."] = {
        ...
        ["frFR"] = "Simplifie l'énoncé des objectifs en supprimant le terme \"tué\" dedans.",
        ["koKR"] = "\"처치\" 등 텍스트를 제거하여 퀘스트 목표를 단순화합니다.",
