...
local questTagCorrections = {
    ...
    [731] = {1, "Elite"}, -- The Absent Minded Prospector
    ...
    [1222] = {84, "Escort"}, -- Stinky's Escape
    [1270] = {84, "Escort"}, -- Stinky's Escape
    ...
    [5342] = {1, "Elite"}, -- The Last Barov
    [5343] = {81, "Dungeon"}, -- Barov Family Fortune
    [5344] = {1, "Elite"}, -- The Last Barov
    ...
    [6641] = {1, "Elite"}, -- Vorsha the Lasher
