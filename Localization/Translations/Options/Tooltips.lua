...
local tooltipOptionsLocales = {
    ...
    ["Show breadcrumb quests"] = {
        ["ptBR"] = "Mostrar missões de encaminhamento",
        ["ruRU"] = "Показать предзадания",
        ["deDE"] = "Zeige Brotkrumen-Quests",
        ["koKR"] = "길잡이 퀘스트 표시",
        ["esMX"] = "Mostrar misiones de migajas",
        ["enUS"] = true,
        ["zhCN"] = "显示线索任务",
        ["zhTW"] = "顯示任務線索",
        ["esES"] = "Mostrar misiones de rastro",
        ["frFR"] = "Afficher les quêtes d'orientation",
    },
    ["If checked, breadcrumb quests will show in the expanded map tooltips."] = {
        ["ptBR"] = "Se marcado, as missões de encaminhamento serão mostradas nas dicas de mapa expandidas.",
        ["ruRU"] = "Когда включено, предзадания будут отображаться в расширенной подсказке на карте",
        ["deDE"] = "Wenn ausgewählt, werden Brotkrumen-Quests in den erweiterten Map-Tooltips angezeigt.",
        ["koKR"] = "이 옵션을 선택하면 길잡이 퀘스트가 확장된 지도 툴팁에 표시됩니다.",
        ["esMX"] = "Si está seleccionado, las misiones de migajas se mostrarán en los tooltips de mapa expandidos.",
        ["enUS"] = true,
        ["zhCN"] = "启用时，线索任务会在展开的地图提示框中显示",
        ["zhTW"] = "啟用時，會在展開的地圖浮動提示資訊中顯示任務線索",
        ["esES"] = "Si está seleccionado, las misiones de rastro se mostrarán en los tooltips de mapa expandidos.",
        ["frFR"] = "Si cette option est cochée, les quêtes d'orientation seront affichées dans les infobulles étendues de la carte.",
    },
